...
# -*- coding: utf-8 -*-
"""
Simple Grasp Demo - Démonstration de grasping sans dépendances complexes
Montre le concept de détection de contact et de grasping avec récompenses
"""
...
class SimpleGraspDemo:
    def __init__(self):
        ...
        self.approach_speed = 0.01
        self.grasp_force = 0.0
        self.lift_speed = 0.005
        ...
        print("Démonstration de grasping simple initialisée")
    ...
    def update_simulation(self):
        ...
        if self.grasp_phase == "approach":
            ...
            self.finger_positions += 0.1  # Fermer les doigts
            self.grasp_force = np.sum(self.finger_positions)
            
            if self.grasp_force > 0.5:
            ...
            if self.cube_position[2] > 0.15:  # Cube levé de plus de 10cm
    ...
    def create_frame(self):
        ...
        # Couleur de fond
        frame[:] = (30, 30, 30)  # Gris très foncé
        
        # Titre
        cv2.putText(frame, "G1 Robot Grasp Simulation Demo", (20, 40), 
    ...
    def run_simulation(self):
        ...
        print("Démarrage de la démonstration de grasping...")
    ...
    def save_video(self, filename="simple_grasp_demo.mp4"):
    ...
    def save_rewards(self, filename="simple_grasp_rewards.txt"):
        ...
        with open(filename, 'w') as f:
            ...
            for i, reward in enumerate(self.reward_history):
                f.write(f"{i},{reward:.6f},{self.grasp_phase},True,{self.grasp_force:.3f},{self.cube_position[2]:.3f}\n")
...
def main():
    ...
    success = demo.run_simulation()
    
    if success:
        print("🎉 Démonstration de grasping réussie!")
        print("📹 Vidéo générée: simple_grasp_demo.mp4")
        print("📊 Données sauvegardées: simple_grasp_rewards.txt")
    else:
        print("❌ Démonstration de grasping échouée")
