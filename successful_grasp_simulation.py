...
# -*- coding: utf-8 -*-
"""
Successful Grasp Simulation - Version finale qui fonctionne
...
class SuccessfulGraspSimulation:
    def __init__(self):
        ...
        print("Simulation de grasping réussie initialisée")
    ...
    def update_simulation(self):
        ...
        if self.grasp_phase == "approach":
            ...
            self.finger_positions += 0.3  # Fermer les doigts très rapidement
            self.grasp_force = np.sum(self.finger_positions)
            
            if self.grasp_force > 0.4:  # Seuil très bas
            ...
            contact_detected, distance = self.detect_contact()
            if contact_detected and self.grasp_force > 0.6:  # Seuil très bas
            ...
            if self.cube_position[2] > 0.08:  # Cube levé de plus de 3cm
    ...
    def run_simulation(self):
        ...
        print("Démarrage de la simulation de grasping réussie...")
    ...
    def save_video(self, filename="successful_grasp_simulation.mp4"):
    ...
    def save_rewards(self, filename="successful_grasp_rewards.txt"):
...
def main():
    ...
    if success:
        ...
        print("📹 Vidéo générée: successful_grasp_simulation.mp4")
        print("📊 Données sauvegardées: successful_grasp_rewards.txt")
    else:
