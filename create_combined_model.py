...
class G1ModelBuilder:
    ...
    def verify_files(self):
        ...
        mesh_files = list(self.meshes_dir.glob("*.STL")) + list(self.meshes_dir.glob("*.stl"))
        if not mesh_files:
    ...
    def fix_mesh_paths(self, xml_file):
        ...
        backup_file = xml_file.with_suffix(xml_file.suffix + '.backup')
    ...
    def create_combined_model(self):
        ...
        print(f"  - {len(joints)*2 + 2} capteurs")
