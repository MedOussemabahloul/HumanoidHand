    ...
    try:
        ...
        for dof_id in range(model.nv):
            ...
            if joint_id < model.njnt:
                ...
                if joint_name:
                    if any(keyword in joint_name.lower() for keyword in ["finger", "thumb","hand"]):
        ...
        print(f"   DOFs problématiques signalés: [15,16,20,21,22,29,30]")
        
        # Vérifier les DOFs problématiques
        problematic_dofs = [15,16,20,21,22,29,30,17,18,19]
