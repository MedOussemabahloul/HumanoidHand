...
try:
    from envs.professional_grasp_env import ProfessionalGraspEnv
...
class ProfessionalGraspTrainer:
    ...
    def __init__(self, episodes: int = 30, record_video: bool = True):
        ...
        self.results_dir = "/home/oussema/Documents/project/professional_grasp_results"
...
def main():
    ...
    try:
        ...
        print(f"📁 Résultats disponibles dans: /home/oussema/Documents/project/professional_grasp_results/")
