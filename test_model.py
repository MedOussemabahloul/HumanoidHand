...
def main():
  ...
  parser.add_argument('--model', type=str, default='/home/oussema/Documents/project/sac_results/bestmodel.zip',
                     help='Chemin vers le modèle')
  parser.add_argument('--episodes', type=int, default=3,
                     help='Nombre d\'épisodes de test')
  parser.add_argument('--video-dir', type=str, default='/home/oussema/Documents/project/test_videos',
