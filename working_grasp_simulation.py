...
# -*- coding: utf-8 -*-
"""
Working Grasp Simulation - Version finale fonctionnelle
...
class WorkingGraspSimulation:
    def __init__(self):
        ...
        self.required_stable_steps = 15
        
        print("Simulation de grasping fonctionnelle initialisée")
    ...
    def update_simulation(self):
        ...
        if self.grasp_phase == "approach":
            ...
            self.finger_positions += 0.2  # Fermer les doigts rapidement
            self.grasp_force = np.sum(self.finger_positions)
            
            if self.grasp_force > 0.6:  # Seuil plus bas
            ...
            contact_detected, distance = self.detect_contact()
            if contact_detected and self.grasp_force > 0.8:  # Seuil plus bas
            ...
            if self.cube_position[2] > 0.1:  # Cube levé de plus de 5cm
    ...
    def run_simulation(self):
        ...
        print("Démarrage de la simulation de grasping fonctionnelle...")
    ...
    def save_video(self, filename="working_grasp_simulation.mp4"):
    ...
    def save_rewards(self, filename="working_grasp_rewards.txt"):
...
def main():
    ...
    if success:
        ...
        print("📹 Vidéo générée: working_grasp_simulation.mp4")
        print("📊 Données sauvegardées: working_grasp_rewards.txt")
    else:
