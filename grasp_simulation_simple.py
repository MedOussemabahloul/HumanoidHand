...
# -*- coding: utf-8 -*-
"""
Simple Grasp Simulation for G1 Robot
Version simplifiée sans mujoco-viewer pour la simulation de grasping
"""
...
def main():
    """Fonction principale"""
    print("=== Simulation Simple de Grasping G1 ===")
    
    # Créer la simulation
    sim = SimpleGraspSimulation()
